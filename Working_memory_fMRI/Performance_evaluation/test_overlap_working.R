...
bayes_adjusted<-to_standard_MNI(readNIfTI('./Bayes_adjusted.nii'))
bayes_707 <-to_standard_MNI(readNIfTI('./Bayes_707.nii')>=3)
fwe<-to_standard_MNI(readNIfTI('./fwe.nii'))
...
bayes_adjusted<-to_standard_MNI(readNIfTI('./bf3_05_80.nii'))
result_bayes_meta<-as.matrix(c(
  calc_overlap(bayes_meta,bayes_adjusted)[1]
))
# neurosynth
...
bayes_adjusted<-to_standard_MNI(readNIfTI('./bf3_05_85.nii'))
result_bayes_meta<-as.matrix(c(
  calc_overlap(bayes_meta,bayes_adjusted)[1]
))
# neurosynth
...
bayes_adjusted<-to_standard_MNI(readNIfTI('./bf3_05_95.nii'))
result_bayes_meta<-as.matrix(c(
  calc_overlap(bayes_meta,bayes_adjusted)[1]
))
# neurosynth
